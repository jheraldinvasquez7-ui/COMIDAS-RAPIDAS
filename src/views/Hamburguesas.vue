  ...
  <q-page class="q-pb-xl">
      ...
      >
        <div class="absolute-full flex flex-center text-center column q-pa-md" style="background: rgba(0, 0, 0, 0.45);">
          ...
          <p class="text-subtitle1 text-grey-3 q-max-w-md" style="max-width: 620px; font-size: 1.05rem;">
            Jugosas carnes a fuego vivo, pan brioche dorado con mantequilla artesanal y combinaciones de ingredientes frescos pensadas para deleitar tu paladar.
          </p>
          <div class="row q-gutter-sm q-mt-sm">
            <q-badge color="negative" class="q-pa-xs q-px-sm text-weight-bold">
              <q-icon name="local_fire_department" class="q-mr-xs" /> A LA PARRILLA
            </q-badge>
            <q-badge color="amber-9" class="q-pa-xs q-px-sm text-weight-bold">
              <q-icon name="verified" class="q-mr-xs" /> PAN BRIOCHE RECIÉN HORNEADO
            </q-badge>
          </div>
        </div>
      </q-img>
    ...
    <div class="text-center q-my-lg q-px-md">
      ...
      <p class="text-grey-8 text-body1" style="max-width: 680px; margin: 0 auto; line-height: 1.6;">
        Elige entre nuestras recetas clásicas y creaciones de autor. Cada una incluye una porción de papas a la francesa o rústicas crocantes.
      </p>
    </div>
      ...
      <q-card v-if="productoSeleccionado" style="min-width: 340px; max-width: 520px; border-radius: 20px;">
        ...
        <q-card-section class="q-pt-md">
          ...
          <q-input
            ...
            outlined
            dense
            label="Notas especiales (ej. sin cebolla, salsa aparte)"
            class="q-mt-md"
          />
        </q-card-section>
...
const productos = ref([
  {
    ...
    descripcion: 'Jugosa carne de res Angus 180g, queso cheddar derretido, lechuga romana, tomate y salsa especial de la casa.',
    ingredientes: 'Pan brioche artesanal, carne de res 180g a la parrilla, queso cheddar madurado, tomate milano fresco, lechuga crespa y aderezo Burger Bite.',
    precio: 21900,
    etiqueta: 'Más Pedido',
    esRecomendado: false,
  ...
  {
    id: 'h-chef-monster',
    nombre: 'Monstruosa de tocineta y queso',
    descripcion: 'Doble carne de res 320g, doble queso americano, tocineta ahumada crujiente en caramelo de maple y aros de cebolla.',
    ingredientes: 'Doble carne angus 160g c/u, tocineta ahumada crocante, queso cheddar fundido, cebolla crispy caramelizada, salsa BBQ ahumada y pan brioche.',
    precio: 29500,
    etiqueta: '',
    esRecomendado: true, // DESTACADO RECOMENDACIÓN DEL CHEF
    imagen: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?auto=format&fit=crop&w=800&q=80'
  },
  {
    id: 'h-spicy-chicken',
    nombre: 'Spicy Crispy Chicken',
    descripcion: 'Pechuga de pollo apanada ultra crocante bañada en salsa hot spicy, pepinillos dulces y mayonesa de ajo asado.',
    ingredientes: 'Filete de pechuga macerada en suero y especias cajún, coleslaw fresco, pepinillos encurtidos y mayonesa de ajo rostizado en pan artesanal.',
    precio: 23900,
    etiqueta: 'Picante',
    esRecomendado: false,
    imagen: 'https://images.unsplash.com/photo-1625813506062-0aeb1d7a094b?auto=format&fit=crop&w=800&q=80'
  },
  {
    id: 'h-truffle-shroom',
    nombre: 'Truffle Mushroom Burger',
    descripcion: 'Carne Angus premium, queso suizo Emmental, champiñones salteados al ajillo y reducción de trufa negra.',
    ingredientes: 'Carne de res seleccionada 180g, champiñones portobello y parís salteados en vino blanco, queso suizo y mayonesa trufada.',
    precio: 27500,
    etiqueta: 'Nuevo',
    esRecomendado: false,
    imagen: 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?auto=format&fit=crop&w=800&q=80'
  }
])
